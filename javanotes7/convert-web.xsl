...
<xsl:template match="/">
   <redirect:write file="web/index.html">
        ...
        <p style="text-align:center">(Version 7.0.1, with just a few corrections, August 2015)</p>
<!--
        <p align="center">
        <small><i>(This revision is nearly finished, to be completed by end of summer.)</i></small>
        </p>
-->
        ...
        <p>The seventh edition requires Java 7, with just a couple brief mentions of Java 8.
         ...
         PDF and print versions of the textbook are also available.
        ...
        <li>
          ...
          <!-- 
          <li><b><a href="http://math.hws.edu/eck/cs124/downloads/javanotes7.tar.bz2">http://math.hws.edu/eck/cs124/downloads/javanotes7.tar.bz2</a></b> &#8212;
          This "bzip2 tar" archive contains a complete copy of the web site in a format that allows greater compression
          but that might not be usable on all computers.  (It duplicates the above .zip archive.) 
          (Size:&#160;3.5&#160;Megabytes.)
          </li>
          -->
          </ul>
        ...
        <li>
          ...
          a PDF version without links, more suitable for printing.  This is the PDF that is used for the printed version of the text,
        ...
        <!-- 
        <li>
        <b><a href="http://math.hws.edu/eck/cs124/downloads/javanotes7.epub">http://math.hws.edu/eck/cs124/downloads/javanotes7.epub</a>, and
        <a style="white-space:pre" href="http://math.hws.edu/eck/cs124/downloads/javanotes7.mobi">http://math.hws.edu/eck/cs124/downloads/javanotes7.mobi</a></b> &#8212;
        ...
        <li>
          ...
          were fixed in Version 7.0.1.  See the on-line <a href="http://math.hws.edu/javanotes/news.html">news page</a> for a list of 
          substantive errors.
          </li>
          </ul>
        </li>
